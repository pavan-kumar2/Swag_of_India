            ...
            <div class="col-md-6 col-12 pad-sm-xsm-0">
                <div class="product-info">
                    ...
                    <div class="product-discount-off">
                        <p class="">Rs ${curr.priceAfterDiscount * curr.qty} <span>Rs ${curr.price * curr.qty}</span><span> (${curr.offers} Off)</span></p>
                    </div>
                    ...
                    <div class="product-btn-group">
                        <a href="./my_carts.html"><button onclick="moveToCart('${curr.id}', '${encodeURI(JSON.stringify(curr))}')">ADD TO CART</button></a>
                        <a href="./checkout.html"><button>BUY NOW</button></a>
                        <a href="./my_wishlist.html" class="save-product"><div class="width-sm-xsm d-flex align-items-center justify-content-center" onclick="moveToWishList('${curr.id}', '${encodeURI(JSON.stringify(curr))}')">
